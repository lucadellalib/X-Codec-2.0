...
from xcodec2.vq import activations, blocks
from xcodec2.vq.alias_free_torch import *
from xcodec2.vq.bs_roformer5 import TransformerBlock
from xcodec2.vq.module import DecoderBlock, ResLSTM, WNConv1d
from xcodec2.vq.position_embeddings import RotaryPositionalEmbeddings
...
class CodecDecoder_oobleck_Transformer(nn.Module):
    ...
    def pre_conv(self, out_channels):
        return nn.Conv1d(
            in_channels=self.hidden_dim, out_channels=out_channels, kernel_size=1
        )
